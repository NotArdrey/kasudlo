...
void main() {
    ...
    if (runs.length > 1) {
      ...
      if (texts.length > 1) {
        ...
        for (var i = 1; i < texts.length; i++) {
          texts[i].innerText = ''; // Clear other texts instead of removing to avoid breaking XML tree
        }
        mergedCount++;
      }
    }
  ...
  print('Contains "Respect for elderly": ${fullXml.contains('Respect for elderly')}');
