...
void main() async {
  ...
  final serviceRoleKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9tYmZpbHN3eW11aHNhb3ZlZnVjIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3OTUzNTg0MSwiZXhwIjoyMDk1MTExODQxfQ.Y0bOuQwDqDdtjoT6ZftrfGGLo4yKrfFXYj4Y18qeVfk';
  ...
  try {
    ...
    if (e.toString().contains('User already registered')) {
      ...
      try {
        final existing = await client.from('auth.users').select('id').eq('email', email).single();
